...
site: "guangzhengli.com"
domain: "guangzhengli.com"
author:
published: 2023-07-15
created: 2026-05-25
description: "也许你最近可能听过这样的新闻，某向量数据库的初创公司刚写好 PPT，就获得了几千万的投资，某公司的开源的向量数据库因其代码的简陋而登上了 Hackernews 等等。在过去几个月时间中， AI 应用的发展如火如荼，带动了 AI 应用技术栈上下游的火爆，而向量数据库就是其中最热门的之一。"
language: "zh-CN"
word_count: 9719
...
![Embedding](https://guangzhengli.com/_next/static/media/Embedding.03d9e088.png)
...
![Snipaste_2023-07-15_20-55-09](https://guangzhengli.com/_next/static/media/Snipaste_2023-07-15_20-55-09.95387e5c.png)

Snipaste\_2023-07-15\_20-55-09

然而单靠一个体型大小的特征并不够，像照片中哈士奇、金毛和拉布拉多的体型就非常接近，我们无法区分。所以我们会继续观察其它的特征，例如毛发的长短。

![Snipaste_2023-07-15_20-59-13](https://guangzhengli.com/_next/static/media/Snipaste_2023-07-15_20-59-13.ad05bb2c.png)

Snipaste\_2023-07-15\_20-59-13
...
![kmeans](https://guangzhengli.com/_next/static/media/kmeans.2978a558.png)
...
![WUjl5M](https://guangzhengli.com/_next/static/media/WUjl5M.7b19dd1e.jpg)

那么为了解决搜索时可能存在的遗漏问题，可以将搜索范围动态调整，例如当 nprobe = 1 时，只搜索最近的一个聚类中心，当 nprobe = 2 时，搜索最近的两个聚类中心，根据实际业务的需求调整 nprobe 的值。

![FZadSG](https://guangzhengli.com/_next/static/media/FZadSG.bb23399a.jpg)
...
![5dAeV5](https://guangzhengli.com/_next/static/media/5dAeV5.a5068c29.jpg)
...
![GD7ufK](https://guangzhengli.com/_next/static/media/GD7ufK.e23f8add.jpg)

解决这个问题的思路与常见的跳表算法相似，如下图要搜索跳表，从最高层开始，沿着具有最长“跳过”的边向右移动。如果发现当前节点的值大于要搜索的值-我们知道已经超过了目标，因此我们会在下一级中向前一个节点。

![wOu6JL](https://guangzhengli.com/_next/static/media/wOu6JL.15844513.jpg)
...
![lsh2](https://guangzhengli.com/_next/static/media/lsh2.c8458a47.png)
...
![lsh3](https://guangzhengli.com/_next/static/media/lsh3.17348587.png)
...
$$d(\\mathbf{A}, \\mathbf{B}) = \\sqrt{\\sum\_{i=1}^{n}(A\_i - B\_i)^2}$$

其中，$\\mathbf{A}$ 和 $\\mathbf{B}$ 分别表示两个向量，$n$ 表示向量的维度。

![KPhJ27](https://guangzhengli.com/_next/static/media/KPhJ27.c3e389ce.jpg)
...
![fHLAfz](https://guangzhengli.com/_next/static/media/fHLAfz.62e310e7.jpg)
...
![kyA3AN](https://guangzhengli.com/_next/static/media/kyA3AN.eeb813c7.jpg)
...
![VwZxFW](https://guangzhengli.com/_next/static/media/VwZxFW.080bc5e9.jpg)
...
博客同步发布到 [NextDevKit Blog Vector Database](https://nextdevkit.com/zh/blog/vector-database) 。
...
- [K-Means 和 Faiss](#k-means-和-faiss)
...
- [Random Projection for LSH 随机投影](#random-projection-for-lsh-随机投影)
- [相似性测量 (Similarity Measurement)](#相似性测量-similarity-measurement)
- [欧几里得距离（Euclidean Distance）](#欧几里得距离euclidean-distance)
- [余弦相似度（Cosine Similarity）](#余弦相似度cosine-similarity)
- [点积相似度 (Dot product Similarity)](#点积相似度-dot-product-similarity)
