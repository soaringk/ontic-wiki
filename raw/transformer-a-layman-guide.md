---
title: "白话科普：Transformer和注意力机制 - 铁蕾的个人博客"
source: "https://zhangtielei.com/posts/blog-transformer-attention.html"
author:
published:
created: 2026-04-24
description: "白话科普：Transformer和注意力机制 - 铁蕾的个人博客 - 作者:张铁蕾"
tags:
  - "clippings"
---
[首页](https://zhangtielei.com/) > > 正文
...
[![大模型技术进化树](https://zhangtielei.com/assets/images_transformer/llm_evolutionary_tree.jpg)](https://zhangtielei.com/assets/images_transformer/llm_evolutionary_tree.jpg)
...
[![Transformer的模型架构](https://zhangtielei.com/assets/images_transformer/transformer_model_arch.jpg)](https://zhangtielei.com/assets/images_transformer/transformer_model_arch.jpg)
...
[![Transformer英翻德](https://zhangtielei.com/assets/images_transformer/transformer_black_box.jpg)](https://zhangtielei.com/assets/images_transformer/transformer_black_box.jpg)

给Transformer输入一个英文句子，它就输出一个德文句子。

但是，具体拆解来看的话，它并不是 **一下子** 把整个德文句子输出出来的。它是一个单词一个单词地生成的。如下图：

[![Transformer按token生成](https://zhangtielei.com/assets/images_transformer/transformer_time_steps.jpg)](https://zhangtielei.com/assets/images_transformer/transformer_time_steps.jpg)
...
[![Transformer模块图](https://zhangtielei.com/assets/images_transformer/transformer_submodules.jpg)](https://zhangtielei.com/assets/images_transformer/transformer_submodules.jpg)
...
[![一个共指关系的自注意力的例子](https://zhangtielei.com/assets/images_transformer/transformer_blog_coreference.png)](https://zhangtielei.com/assets/images_transformer/transformer_blog_coreference.png)
...
一旦有了token输入，整个生成过程就可以执行起来了。图中右下方的 ***Generator*** 每次生成一个新的token，再把这个新生成的token当做输入，并以此为条件继续生成token。在Transformer模块图中，图的下半部分展示了生成过程中的一个时刻：根据上一步已经生成的序列“Ein kleines Mädchen”，正在生成下一个token：「schaut」。图中的数字 `[2, 5, 69, 27] ` 以及 `[100]` ，表示相应token在德文字典中的索引编号。
...
[![mask矩阵](https://zhangtielei.com/assets/images_transformer/transformer_target_mask.jpg)](https://zhangtielei.com/assets/images_transformer/transformer_target_mask.jpg)
...
[![Transformer的编码+解码动态过程](https://zhangtielei.com/assets/images_transformer/transformer_encoding_decoding.gif)](https://zhangtielei.com/assets/images_transformer/transformer_encoding_decoding.gif)
...
**本文链接：** [http://zhangtielei.com/posts/blog-transformer-attention.html](http://zhangtielei.com/posts/blog-transformer-attention.html)  
**欢迎关注我的个人微博：微博上搜索我的名字「张铁蕾」。**  
![我的微信公众号: tielei-blog (张铁蕾)](https://zhangtielei.com/assets/my_weixin_sign_sf_840.jpg)

上篇： [对于2024年初的大模型，我们期待什么？](https://zhangtielei.com/posts/blog-llm-2024.html)

下篇： [企业AI智能体、数字化与行业分工](https://zhangtielei.com/posts/blog-ai-agent-to-b.html)
...
- [Claude Managed Agents意味着什么？](https://zhangtielei.com/posts/blog-claude-managed-agents.html)
- [【开源】专为「探路+编码」范式设计的全新浏览器工具集+Skills](https://zhangtielei.com/posts/blog-release-bridgic-browser.html)
- [不用手写一行代码，10分钟立等可取，爬取twitter和github动态](https://zhangtielei.com/posts/blog-karpathy-tracker.html)
- [使用OpenClaw时如何降低token消耗？分享一个浏览器自动化的skill](https://zhangtielei.com/posts/blog-myblog-checker.html)
- [过年了，聊聊AI和人文](https://zhangtielei.com/posts/blog-ai-summary.html)
- [使用Bridgic长程自主模块+MCP，控制你的浏览器](https://zhangtielei.com/posts/blog-bridgic-mcp.html)
- [AI智能体纪元或将从2026开始归零](https://zhangtielei.com/posts/blog-agents-outlook.html)
- [从Python异步编程的剖析中体会智能体并发编程模式](https://zhangtielei.com/posts/blog-bridgic-concurrency-mode.html)
- [【开源】智能体编程语言ASL——重构智能体开发体验](https://zhangtielei.com/posts/blog-bridgic-asl.html)
