---
kind: source
title: Private Credit Podcast
slug: private-credit-podcast
source_ids:
  - raw-private-credit-podcast
status: active
...
The source offers a market-structure view rather than a product pitch. It is useful because it connects borrower incentives, investor yield demand, regulatory arbitrage, and systemic-risk transmission into one picture, especially around private credit's role in funding AI-related infrastructure.

# Connections

- Topic: [Private Credit](../topics/private-credit.md)
- Concept: [Unitranche Loans](../concepts/unitranche-loans.md)
- Concept: [Rated Note Feeders](../concepts/rated-note-feeders.md)

# Open Questions

- The transcript argues that private credit has not been tested by a full adverse credit cycle, but it does not establish a clear trigger for when refinancing stress turns into systemic stress.
- Some claims about contagion risk and crisis parallels are plausible but framed as warnings rather than demonstrated outcomes.
