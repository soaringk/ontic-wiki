...
- MLA (Multi-head Latent Attention) compresses K and V jointly into a low-rank latent vector, caching the compressed representation and reconstructing on-the-fly. The undated KV-cache survey reports approximately 96% dimensional reduction at DeepSeek V3 scale; this figure still needs primary-source verification.
